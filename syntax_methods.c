...
int syntax_check (struct Node_Op** cmd_ptoptr, char* cmd_text) {
    ...
    for (index_of_cmd_text = 0; index_of_cmd_text < VARIABLE_LEN; index_of_cmd_text++) {
        ...
        /*
            ...
            variable_text[1] = '\0';
            end = add_end_of_Node_Op(999, tmp_ptoptr, end);
            end = add_data(variable_text, end);index_of_variable_text = 0;
            memset(variable_text, '\0', VARIABLE_LEN);
            // add '('
            variable_text[0] = '(';
            variable_text[1] = '\0';
            ...
            // ............
                ...
                if (index_of_variable_text > 0) {
                    variable_text[index_of_variable_text + 1] = '\0';
                    end = add_end_of_Node_Op(500, tmp_ptoptr, end);
                    end = add_data(variable_text, end);
                    index_of_variable_text = 0;
                    memset(variable_text, '\0', VARIABLE_LEN);
                }
            ...
            bracket_signal = top_Node(bracket_ptoptr);
            if (bracket_signal == 0) {
                syntax_error_signal = 1;
                break;
            } else if (bracket_signal == 4) {
                is_operant = 3;
            }
        ...
        */
        ...
        /*
            ...
            */
                ...
                if (index_of_variable_text > 0) {
                    variable_text[index_of_variable_text + 1] = '\0';
                    end = add_end_of_Node_Op(is_operant, tmp_ptoptr, end);
                    end = add_data(variable_text, end);
                    index_of_variable_text = 0;
                    memset(variable_text, '\0', VARIABLE_LEN);
                }
                ...
                variable_text[1] = '3';
                variable_text[2] = '\0';
                end = add_end_of_Node_Op(11, tmp_ptoptr, end);
                end = add_data(variable_text, end);
                index_of_variable_text = 0;
                memset(variable_text, '\0', VARIABLE_LEN);
            ...
            variable_text[0] = cmd_text[index_of_cmd_text];
            variable_text[1] = '\0';
            end = add_end_of_Node_Op(1100, tmp_ptoptr, end);
            end = add_data(variable_text, end);
            index_of_variable_text = 0;
            memset(variable_text, '\0', VARIABLE_LEN);
        */
    ...
    if (syntax_error_signal) {
        ...
        printf("\n");
        printf("Command processing: ");
        print_Node_Op_dtype(tmp_ptoptr);
